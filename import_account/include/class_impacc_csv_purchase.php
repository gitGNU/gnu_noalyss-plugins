...
class Impacc_Csv_Purchase extends Impacc_Csv_Sale_Purchase
{
    ...
    function adapt( $p_row)
    {
        ...
        $array['e_pj']=trim($all_row[0]->id_pj);
        $array['mt']=microtime();
        $array['jrn_type']='ACH';
    ...
    function insert($a_group, Acc_Ledger_Purchase $p_ledger)
    {
       $cn=Dossier::connect();
       ...
       for ( $i=0;$i< $nb_group;$i++)
       {
           ...
           // Update this group , status = 2 and jrn_id
           // and date_payment
