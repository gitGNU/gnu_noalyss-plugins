function show_declaration(p_type,p_id) {
	...
	$('detail').show();
	$('main').hide();
	var gDossier=$('gDossier').value; var phpsessid=$('phpsessid').value;var code=$('code').value;
	var queryString='?act=dsp_decl&gDossier='+gDossier+'&PHPSESSID='+phpsessid+'&code='+code;
